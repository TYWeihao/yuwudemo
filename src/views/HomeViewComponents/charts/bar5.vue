...
onMounted(() => {
  ...
  let option = {
    ...
    legend: {
      data: ["总抽采量(吨)", "瓦斯利用量(吨)", "总排放量", "瓦斯利用率(%)"],
      textStyle: {
        color: "#ffffffb3",
      },
      bottom: 0,
