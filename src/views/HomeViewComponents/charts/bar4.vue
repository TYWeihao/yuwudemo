...
const obj = {
  color: ["#11318d", "#246bd3", "#00ffff", "#27e2f9", "#5394ef", "#0b5abe"],
...
echarts.registerTheme("walden4", obj);
onMounted(() => {
  let myChart = echarts.init(echartsRef.value, "walden4");
  // let value = 0.5;
    ...
    series: [
      {
        ...
        data: [64733.06, 60895.46, 51229.25, 54015.93],
      },
    ],
  };
