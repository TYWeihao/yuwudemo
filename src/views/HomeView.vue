...
<template>
  <main>
        ...
        <div class="left-box-content" style="overflow: hidden; width: 100%">
          <article class="jianjie">
            ...
            <div class="jianjie_content">
              <span class="jianjie_title semi">余吾煤业公司（屯留煤矿）</span>
              <span
                class="jianjie_subtitle semi">位于山西省长治市屯留县，属潞安矿区。井田面积162.2平方公里，地质储量15.45亿吨，可采储量6.81亿吨，设计能力600万吨/年，配套600万吨/年的洗煤厂，概算总投资270007万元。</span>
              <p class="jianjie_description semi">
    ...
    align-items: center;
    font-size: 0.6rem;
">同比 <img class="down" style="transform:rotateX(180deg);width: 0.2rem;height: 0.5rem;margin: 2px 0.1rem 0;"
                    src="/src/assets/img/up.png" alt="" data-v-b4e148ca=""> 2.5% </small>
              </div>
            </div>
    ...
    font-size: 0.6rem;
">同比 <img class="down" style="transform:rotateX(180deg);width: 0.2rem;height: 0.5rem;margin: 2px 0.1rem 0;"
                    src="/src/assets/img/up.png" alt="" data-v-b4e148ca=""> 3.2% </small>
              </div>
            </div>
    ...
    font-size: 0.6rem;
">同比 <img class="down" style="transform:rotateX(180deg);width: 0.2rem;height: 0.5rem;margin: 2px 0.1rem 0;"
                    src="/src/assets/img/up.png" alt="" data-v-b4e148ca=""> 1.5% </small>
              </div>
            </div>
          </div>
          <div style="width: 33%">
    ...
    font-size: 0.6rem;
">同比 <img class="down" style="transform:rotateX(180deg);width: 0.2rem;height: 0.5rem;margin: 2px 0.1rem 0;"
                    src="/src/assets/img/up.png" alt="" data-v-b4e148ca=""> 2.7% </small>
              </div>
            </div>
    ...
    font-size: 0.6rem;
">同比 <img class="down" style="transform:rotateX(180deg);width: 0.2rem;height: 0.5rem;margin: 2px 0.1rem 0;"
                    src="/src/assets/img/up.png" alt="" data-v-b4e148ca=""> 2.9% </small>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="date-box">
                <span class="month">
                  <div style="display: flex; align-items: center;font-size:10px">
                    <img class="down" style="  width: 0.2rem;  height: 0.6rem;  margin: 3px 2px 0  ;"
          ...
          <div class="parent">
            <div class="card">
              ...
              <div class="date-box">
                <span class="month">
                  <div style="display: flex; align-items: center;font-size:10px">
                    <img class="down" style="  width: 0.2rem;  height: 0.6rem;  margin: 1px 2px 0  ;"
                      src="./../assets/img/up.png" alt="" />
                    4.5%
                  </div>
                </span>
          ...
          <div class="parent">
            <div class="card">
              ...
              <div class="date-box">
                <span class="month">
                  <div style="display: flex; align-items: center;font-size:10px">
                    <img class="down" style="  width: 0.2rem;  height: 0.6rem;  margin: 3px 1px 0  ;"
                      src="./../assets/img/down.png" alt="" />
                    1.5%
                  </div>
                </span>
        ...
        <div class="right-box-content">
          <div style="display: flex">
            <div class="flex-y" style="width: 30%; font-size: 0.8rem; display: flex">
              <div
                style="color: #6be6c1;text-align: left;font-size: 0.8rem;display: flex;justify-content: space-between;">
                <div class="row" style="align-items: center">
                  <div class="circle" style="background-color: #6be6c1"></div>
              ...
              <div
                style="color: #99ffff;text-align: left;font-size: 0.8rem;display: flex;justify-content: space-between;">
                <div class="row" style="align-items: center">
...
.title::after {
    ...
    bottom: 0px;
    width: 4px; /* 设置线条的宽度 */
    height: 100%; /* 设置线条的高度为整个标题的高度 */
    background-color: #fffcf7; /* 设置粗线的颜色 */
}
...
.title::before {
    ...
    width: 2px; /* 设置细线的宽度 */
    height: 100%; /* 设置线条的高度为整个标题的高度 */
    background-color: #fffcf7; /* 设置细线的颜色 */
}
