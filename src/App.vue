...
<template>
  <header>
    ...
    <div
      style="position: fixed; left: 1.5rem; top: 10px; display: flex; align-items: center"
    >
      <img
    ...
    <div class="guide">
      ...
      <!-- <div
        class="guide-button"
        :class="{ active: path == '/zhongdianshebei' }"
        @click="changePath('/zhongdianshebei')"
      >
        重点设备
      </div> -->
    </div>
...
main {
  height: calc(100vh - calc(100vw / 1920 * 92));
  display: grid;
